...
var _ authtypes.GenesisAccount = (*SedaGenesisAccount)(nil)

// SedaGenesisAccount defines a type that implements the GenesisAccount interface
// to be used for simulation accounts in the genesis state.
type SedaGenesisAccount struct {
...
func (sga SedaGenesisAccount) Validate() error {
