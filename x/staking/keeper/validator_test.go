...
func bootstrapValidatorTest(t testing.TB, power int64, numAddrs int) (*sedaapp.SedaApp, sdk.Context, []sdk.AccAddress, []sdk.ValAddress) {
...
func initValidators(t testing.TB, power int64, numAddrs int, powers []int64) (*sedaapp.SedaApp, sdk.Context, []sdk.AccAddress, []sdk.ValAddress, []types.Validator) {
	app, ctx, addrs, valAddrs := bootstrapValidatorTest(t, power, numAddrs)
	pks := sedaapp.CreateTestPubKeys(numAddrs)
...
func TestUpdateValidatorByPowerIndex(t *testing.T) {
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(app.StakingKeeper.BondDenom(ctx), app.StakingKeeper.TokensFromConsensusPower(ctx, 1234)))))
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(app.StakingKeeper.BondDenom(ctx), app.StakingKeeper.TokensFromConsensusPower(ctx, 10000)))))
...
func TestSlashToZeroPowerRemoved(t *testing.T) {
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(app.StakingKeeper.BondDenom(ctx), valTokens))))
...
func TestGetValidatorSortingMixed(t *testing.T) {
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(app.StakingKeeper.BondDenom(ctx), app.StakingKeeper.TokensFromConsensusPower(ctx, 501)))))
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(app.StakingKeeper.BondDenom(ctx), app.StakingKeeper.TokensFromConsensusPower(ctx, 0)))))
...
func TestGetValidatorsEdgeCases(t *testing.T) {
	...
	for i, power := range powers {
		...
		notBondedPool := app.StakingKeeper.GetNotBondedPool(ctx)
		require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(params.BondDenom, tokens))))
		app.AccountKeeper.SetModuleAccount(ctx, notBondedPool)
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), newTokens))
	app.AccountKeeper.SetModuleAccount(ctx, notBondedPool)
	...
	bondedPool := app.StakingKeeper.GetBondedPool(ctx)
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(params.BondDenom, rmTokens))))
	app.AccountKeeper.SetModuleAccount(ctx, bondedPool)
	...
	notBondedPool = app.StakingKeeper.GetNotBondedPool(ctx)
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(params.BondDenom, sdk.NewInt(200)))))
	app.AccountKeeper.SetModuleAccount(ctx, notBondedPool)
