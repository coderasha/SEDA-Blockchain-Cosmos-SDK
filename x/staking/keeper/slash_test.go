...
func bootstrapSlashTest(t *testing.T, power int64) (*sedaapp.SedaApp, sdk.Context, []sdk.AccAddress, []sdk.ValAddress) {
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), bondedCoins))
...
func TestSlashRedelegation(t *testing.T) {
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), startCoins))
	app.AccountKeeper.SetModuleAccount(ctx, bondedPool)
...
func TestSlashWithRedelegation(t *testing.T) {
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), rdCoins))
...
func TestSlashBoth(t *testing.T) {
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), bondedCoins))
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), notBondedCoins))
