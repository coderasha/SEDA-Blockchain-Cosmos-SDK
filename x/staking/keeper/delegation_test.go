...
func TestDelegation(t *testing.T) {
	...
	addrDels := sedaapp.AddTestAddrsIncremental(app, ctx, 3, sdk.NewInt(10000))
...
func TestUnbondingDelegation(t *testing.T) {
	...
	delAddrs := sedaapp.AddTestAddrsIncremental(app, ctx, 2, sdk.NewInt(10000))
	valAddrs := sedaapp.ConvertAddrsToValAddrs(delAddrs)
...
func TestUnbondDelegation(t *testing.T) {
	...
	delAddrs := sedaapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(10000))
	valAddrs := sedaapp.ConvertAddrsToValAddrs(delAddrs)

	startTokens := app.StakingKeeper.TokensFromConsensusPower(ctx, 10)
	notBondedPool := app.StakingKeeper.GetNotBondedPool(ctx)

	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(app.StakingKeeper.BondDenom(ctx), startTokens))))
...
func TestUnbondingDelegationsMaxEntries(t *testing.T) {
	...
	addrDels := sedaapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(10000))
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), sdk.NewCoins(sdk.NewCoin(bondDenom, startTokens))))
	app.AccountKeeper.SetModuleAccount(ctx, notBondedPool)
...
func TestUndelegateSelfDelegationBelowMinSelfDelegation(t *testing.T) {
	...
	notBondedPool := app.StakingKeeper.GetNotBondedPool(ctx)
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), delCoins))
	app.AccountKeeper.SetModuleAccount(ctx, notBondedPool)
	...
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, bondedPool.GetName(), delCoins))
...
func TestUndelegateFromUnbondingValidator(t *testing.T) {
	...
	addrDels := sedaapp.AddTestAddrsIncremental(app, ctx, 2, sdk.NewInt(0))
	addrVals := sedaapp.ConvertAddrsToValAddrs(addrDels)
...
func TestRedelegateToSameValidator(t *testing.T) {
	...
	addrDels := sedaapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(0))
	addrVals := sedaapp.ConvertAddrsToValAddrs(addrDels)
	...
	// add bonded tokens to pool for delegations
	notBondedPool := app.StakingKeeper.GetNotBondedPool(ctx)
	require.NoError(t, sedaapp.FundModuleAccount(app.BankKeeper, ctx, notBondedPool.GetName(), startCoins))
	app.AccountKeeper.SetModuleAccount(ctx, notBondedPool)
